...
<Note>
Looking for the flow **people** go through, with phases, approvers and due dates? That is a [Pipe](/en/automation/pipes). A **Process** is the routine **agents** run on their own.
</Note>
